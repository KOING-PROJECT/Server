...
insert into user_table (id, email, password, phone_number, name, birth_date, country, gender, age, enabled, created_at, updated_at) values (2, 'steve1@naver.com', '1111', '12341234', 'steve', '19950315', 'america','Man', '24', TRUE , now(), now());
