...
//    LOGIN_SUCCESS(OK, "signIn : 로그인 성공입니다."),
    ...
    TOUR_COMPLETE_SUCCESS(CREATED, "tour : 투어 완성 성공입니다."),
    TOUR_SCHEDULE_COMPLETE_SUCCESS(CREATED, "tour-schedule : 투어 스케줄 완성 성공입니다."),
    TOUR_SURVEY_COMPLETE_SUCCESS(CREATED, "tour-survey : 투어 설문 완성 성공입니다."),
    FCM_TOKEN_CREATE_SUCCESS(CREATED, "fcm : FCM 토큰 생성 성공입니다."),
    FCM_TOKEN_UPDATE_SUCCESS(CREATED, "fcm : FCM 토큰 업데이트 성공입니다."),
    USER_CATEGORY_INDEXES_UPDATE_SUCCESS(CREATED, "user : 유저 선호 카테고리 업데이트 성공입니다."),
    ACCOUNT_CREATE_SUCCESS(CREATED, "account : 계좌 정보 생성 성공입니다."),
    ACCOUNT_UPDATE_SUCCESS(CREATED, "account : 계좌 정보 업데이트 성공입니다."),
    PAYMENT_CREATE_SUCCESS(CREATED, "payment : 결제 정보 생성 성공입니다."),
