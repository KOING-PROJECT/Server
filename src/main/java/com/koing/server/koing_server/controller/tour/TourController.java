...
public class TourController {
    ...
    @Operation(description = "Tour - 투어 리스트를 가져옵니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Tour - 투어 리스트 가져오기 성공"),
    ...
    @Operation(description = "Tour - 투어를 생성합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Tour - 생성 성공"),
            @ApiResponse(responseCode = "401", description = "토큰이 없습니다."),
    ...
    @Operation(description = "Tour - 생성중인 투어를 임시 저장합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Tour - 투어 임시 저장 성공"),
            @ApiResponse(responseCode = "401", description = "토큰이 없습니다."),
            @ApiResponse(responseCode = "402", description = "투어 생성과정에서 오류가 발생했습니다. 다시 시도해 주세요."),
            @ApiResponse(responseCode = "402", description = "이미지 저장 과정에서 오류가 발생했습니다."),
            @ApiResponse(responseCode = "404", description = "탈퇴했거나 존재하지 않는 유저입니다."),
    ...
    @Operation(description = "Tour - 투어를 삭제합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Tour - 투어 삭제 성공"),
            @ApiResponse(responseCode = "401", description = "삭제할 Tour가 존재하지 않습니다."),
            @ApiResponse(responseCode = "500", description = "예상치 못한 서버 에러가 발생했습니다.")
    })
    ...
    @Operation(description = "Tour - 투어를 업데이트합니다.(완성 tour 혹은 임시저장 tour를 업데이트)")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Tour - 투어 업데이트 성공"),
            @ApiResponse(responseCode = "402", description = "이미지 저장 과정에서 오류가 발생했습니다."),
            @ApiResponse(responseCode = "404", description = "해당 투어를 찾을 수 없습니다."),
            @ApiResponse(responseCode = "404", description = "존재하지 않는 투어 카테고리 입니다."),
            @ApiResponse(responseCode = "406", description = "해당 투어의 생성자가 아닙니다."),
            @ApiResponse(responseCode = "500", description = "예상치 못한 서버 에러가 발생했습니다.")
    })
    ...
    @Operation(description = "Tour - 투어를 승인합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Tour - 투어 승인 성공"),
    ...
    @Operation(description = "Tour - 투어를 거절합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Tour - 투어 거절 성공"),
    ...
    @Operation(description = "Tour - 투어 모집을 시작합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Tour - 투어 모집 시작 성공"),
            @ApiResponse(responseCode = "402", description = "투어 모집 시작 과정에서 오류가 발생했습니다."),
            @ApiResponse(responseCode = "404", description = "해당 투어를 찾을 수 없습니다."),
            @ApiResponse(responseCode = "500", description = "예상치 못한 서버 에러가 발생했습니다.")
    })
    ...
    @Operation(description = "Tour - 투어를 비활성화 합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Tour - 투어 비활성화 성공"),
            @ApiResponse(responseCode = "402", description = "투어 비활성화 과정에서 오류가 발생했습니다."),
            @ApiResponse(responseCode = "402", description = "투어 신청서 비활성화 과정에서 오류가 발생했습니다."),
            @ApiResponse(responseCode = "404", description = "해당 투어를 찾을 수 없습니다."),
            @ApiResponse(responseCode = "500", description = "예상치 못한 서버 에러가 발생했습니다.")
    })
    ...
    @Operation(description = "Tour - 투어를 활성화 합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Tour - 투어 활성화 성공"),
            @ApiResponse(responseCode = "402", description = "투어 활성화 과정에서 오류가 발생했습니다."),
            @ApiResponse(responseCode = "402", description = "투어 신청서 활성화 과정에서 오류가 발생했습니다."),
            @ApiResponse(responseCode = "404", description = "해당 투어를 찾을 수 없습니다."),
            @ApiResponse(responseCode = "500", description = "예상치 못한 서버 에러가 발생했습니다.")
    })
    ...
    @Operation(description = "Tour - 투어를 종료 합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Tour - 투어 종료 성공"),
            @ApiResponse(responseCode = "402", description = "투어 종료 과정에서 오류가 발생했습니다."),
            @ApiResponse(responseCode = "404", description = "해당 투어를 찾을 수 없습니다."),
            @ApiResponse(responseCode = "500", description = "예상치 못한 서버 에러가 발생했습니다.")
    })
    ...
    @Operation(description = "Tour - 투어를 complete 합니다.(임시저장 tour를 완성)")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Tour - 투어 complete 성공"),
            @ApiResponse(responseCode = "402", description = "이미지 저장 과정에서 오류가 발생했습니다."),
            @ApiResponse(responseCode = "404", description = "해당 투어를 찾을 수 없습니다."),
            @ApiResponse(responseCode = "406", description = "해당 투어의 생성자가 아닙니다."),
            @ApiResponse(responseCode = "500", description = "예상치 못한 서버 에러가 발생했습니다.")
    ...
    @Operation(description = "Tour - 투어 세부 정보를 가져옵니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Tour - 투어 세부 정보 가져오기 성공"),
            @ApiResponse(responseCode = "404", description = "해당 투어를 찾을 수 없습니다."),
            @ApiResponse(responseCode = "404", description = "존재하지 않는 페이지 입니다."),
            @ApiResponse(responseCode = "500", description = "예상치 못한 서버 에러가 발생했습니다.")
    })
    ...
    @Operation(description = "Tour - 투어 좋아요를 누릅니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Tour - 투어 좋아요 누르기 성공"),
            @ApiResponse(responseCode = "404", description = "해당 투어를 찾을 수 없습니다."),
    ...
    @Operation(description = "Tour - 좋아요 누른 투어 리스트를 조회합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Tour - 좋아요 누른 투어 리스트를 조회 성공"),
            @ApiResponse(responseCode = "404", description = "해당 유저를 찾을 수 없습니다."),
            @ApiResponse(responseCode = "404", description = "존재하지 않는 페이지 입니다."),
            @ApiResponse(responseCode = "500", description = "예상치 못한 서버 에러가 발생했습니다.")
    })
